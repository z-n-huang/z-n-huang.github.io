...
======
+ Accepted (with revisions). Treebanks and World Englishes: a Singapore English perspective. (With Li Lin, Kunmei Han, Jiawen Hing, Luwen Cao, Vincent Ooi, and Zhiming Bao.) *English World-Wide* {[manuscript](https://z-n-huang.github.io/files/Huangetal_EWW_Treebanks_Singapore_English_202410_preprint.pdf)}.
+ In press. A nearly exhaustive experimental investigation of bridge effects in English. (With Diogo Almeida and Jon Sprouse.) *Language*. {[manuscript](https://z-n-huang.github.io/files/HuangAlmeidaSprouse_Bridge_effects_202410.pdf), [data](https://osf.io/fg6ts/)}
