 ...
 * 
 * Modified work (C) 2020, z-n-huang
 * https://github.com/z-n-huang
 */
'use strict';
...
(function (factory) {
  ...
  OrgChart.prototype = {
    ...
    loopChart: function ($chart) {
	  ...
	  console.log(8888, thenode);  // z-n-huang debug
      var subObj = {//'id': $tr.find('.node')[0].id // z-n-huang removed
					'category': thenode[0].children[0].innerText, // z-n-huang added
					'lex': thenode[0].children[1].innerText  // z-n-huang added
					};	
    ...
    createNode: function (data) {
      ...
      if (opts.nodeTemplate) {
        ...
        $nodeDiv.append('<div class="title">' + data[opts.nodeTitle] + '</div>') // z-n-huang: This adds the category/title
		// z-n-huang: This adds the terminal node/content box
	...
	editLabel: function ($node, titleStr) { // z-n-huang added function
